  ...
  Future<void> _generarReporte() async {
    ...
    try {
      final parametros = {
        ...
        'busqueda': _terminoBusqueda.isNotEmpty ? _terminoBusqueda : null, // Nuevo: término de búsqueda
      };
          ...
          children: [
            ...
            TextFormField(
              decoration: InputDecoration(
                labelText: 'Buscar en reportes',
                hintText: 'Ingresa término de búsqueda (opcional)',
            ...
            Text(
              'Busca por nombre de visitador, institución, municipio, contrato, operador, etc.',
              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                color: Colors.grey[600],
